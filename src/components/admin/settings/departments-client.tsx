...
type Department = {
  ...
  key: string;
  isActive: boolean;
  createdAt: string; // server serializes Date -> string
};
...
export default function DepartmentsClient({
  ...
  const [rows, setRows] = useState<Department[]>(initialData); // hydrate from server
  ...
  async function save() {
    ...
    setOpen(false);
    await refresh(); // fetch once after mutation
  }
