...
type Branch = {
  ...
  isActive: boolean;
  createdAt: string | Date; // ✅ now a string
};
...
export default function BranchesClient({
  ...
  const [rows, setRows] = useState<Branch[]>(initialData); // hydrate from server
  ...
  async function save() {
    ...
    setOpen(false);
    await refresh(); // re-pull once, on demand
  }
