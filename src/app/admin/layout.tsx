...
if (!user?.isActive) redirect("/login?inactive=1");
...
const userForClient: User = {
  ...
  role:
    primary && primaryRoleId ? { id: primaryRoleId, name: primary.name } : null,
...
return (
  <div className="flex h-dvh overflow-hidden bg-gray-100">
    ...
    <div className="flex flex-col flex-1 min-w-0">
      <main className="flex-1 overflow-y-auto no-scrollbar p-2 pb-40">
        {children}
      </main>
    </div>
  </div>
