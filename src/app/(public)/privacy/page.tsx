import { getPrivacyPage } from "@/lib/data/home";
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16">
      ...
      <div className="bg-white p-8 md:p-12 shadow-sm rounded-2xl border border-gray-300 min-h-[400px]">
        {/* Using 'prose' for rich text styling */}
        <div className="prose prose-lg prose-slate max-w-none font-yekan text-gray-700 leading-relaxed text-justify">
          {renderBody()}
        </div>

        {/* Optional: Contact/DPO Section if exists */}
